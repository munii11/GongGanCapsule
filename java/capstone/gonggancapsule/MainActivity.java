...
import capstone.gonggancapsule.database.Diary;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //diaryList.addAll(db.getAllNotes());
        //mAdapter = new DiaryAdapter(this, diaryList);
...
//        setRange()
        ...
        // 일기 DB에 저장하기
        private void createDiary(content, picture){
            // inserting note in db and getting
            // newly inserted note id
            long index = db.insertDiary(content, picture);

            // get the newly inserted note from db, diaryList에 넣을려고 객체를 만듦.
            Diary n = db.getDiary(index);
